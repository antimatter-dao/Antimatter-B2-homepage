...
export default function Ecosystem() {
  const slideArray = [
    ...
    },
    {
      ...
      colorText: "#FFFFFF",
      fill: "white",
      list: ["Choose between different products varying in Strike Price, APY and Delivery Date.", "Options are settled on delivery date in either the token or a stablecoin.", "Dual Investment is available for $BTC, $ETH, $BNB and many more different altcoins."],
    ...
    },
    {
      ...
      colorText: "#121212",
      fill: "black",
      list: ["Our options do not rely on oracles. Instead, arbitrage activity is utilized to determine price of an asset.", "Generated tokens have no expiry and timeframe. This also means no forced liquidation.", "We offer permission-less creation of  Bull & Bear tokens of any asset."],
    ...
    },
    {
      ...
      colorText: "#121212",
      fill: "black",
      list: ["Issuance of NFTs with a combination of multiple underlying assets", "Financial ETFs and formation of customized indexes through NFTs", "Select assets to put into a locker NFT and set a release schedule."],
    ...
    },
    {
      ...
      colorText: "#FFFFFF",
      fill: "white",
      list: ["Everything regarding $MATTER in one place.", "Stake your tokens or collect trading rewards for using our products", "Get involved through governance and give your feedback on our forum"],
